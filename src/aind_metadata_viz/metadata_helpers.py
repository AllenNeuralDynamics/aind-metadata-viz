...
# Acquisition Models
from aind_data_schema.components.devices import Calibration, Maintenance, Software
...
# Rig Models
from aind_data_schema.core.rig import MOUSE_PLATFORMS, STIMULUS_DEVICES, RIG_DAQ_DEVICES
...
from aind_data_schema.core.session import Stream, StimulusEpoch, RewardDeliveryConfig
from aind_data_schema.components.coordinates import Affine3dTransform

# Subject Models
from aind_data_schema.core.subject import BackgroundStrain, BreedingInfo, WellnessReport, Housing
